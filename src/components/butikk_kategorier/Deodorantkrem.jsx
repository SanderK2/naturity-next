...
export default function KategoriDeodorantkrem() {
  ...
  waitForElement("#DeoVanligeProdukter", () => {
    startStore();
  });
...
function startStore() {
  ...
  if (typeof window !== "undefined") {
  if (document.getElementById('DeoVanligeProdukter')) {
  ...
  "toggle": {
    "styles": {
      ...
      ui.createComponent('productSet', {
        id: [],
        node: document.getElementById('DeoNyeProdukter'),
        moneyFormat: '%7B%7Bamount_with_comma_separator%7D%7D%20kr',
        options: {
  "product": {
    "templates": {
...
/*]]>*/
      ...
      ui.createComponent('productSet', {
        id: [8562108924187, 8192493715739, 8103364952347, 8103370391835, 8137521463579, 8137597026587],
        node: document.getElementById('DeoVanligeProdukter'),
        moneyFormat: '%7B%7Bamount_with_comma_separator%7D%7D%20kr',
        options: {
  "product": {
    "templates": {
  ...
  return (
    <main>
      <div id='DeoNyeProdukter'></div>
      <div id='DeoVanligeProdukter'></div>
    </main>
  )
}
